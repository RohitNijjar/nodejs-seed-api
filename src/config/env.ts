...
export const env = {
  ...
  JWT_EXPIRATION: getEnvVariable('JWT_EXPIRATION', '5m'),
  ALLOWED_ORIGIN: getEnvVariable('ALLOWED_ORIGIN', '*'),
  EMAIL_SERVICE: getEnvVariable('EMAIL_SERVICE'),
  EMAIL_JWT_EXPIRATION: getEnvVariable('EMAIL_TOKEN_EXPIRATION', '5m'),
  ...
  REFRESH_TOKEN_EXPIRATION: getEnvVariable('REFRESH_TOKEN_EXPIRATION', '1d'),
